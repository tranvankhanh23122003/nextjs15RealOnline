...
import { 
  ...
  FaBox, FaEye, FaHeart, FaBell, FaTags, 
        ...
        <div className="profile-menu-section">
          ...
          {expanded["Quản lý căn"] && (
            <div className="profile-submenu">
              <Link href="/profile/don-hang" className={`profile-submenu-item ${selectedCategory === "Đơn hàng" ? "active" : ""}`} onClick={() => handleSelectCategory("Đơn hàng")}>
                <FaBox /> Đơn hàng
              </Link>
              <Link href="/profile/da-xem" className={`profile-submenu-item ${selectedCategory === "Đã xem" ? "active" : ""}`} onClick={() => handleSelectCategory("Đã xem")}>
                <FaEye /> Đã xem
              </Link>
              <Link href="/profile/yeu-thich" className={`profile-submenu-item ${selectedCategory === "Yêu thích" ? "active" : ""}`} onClick={() => handleSelectCategory("Yêu thích")}>
                <FaHeart /> Yêu thích
              </Link>
            </div>
          )}
          ...
          {expanded["Thông báo"] && (
            <div className="profile-submenu">
              <Link href="/profile/cap-nhat-don-hang" className={`profile-submenu-item ${selectedCategory === "Cập nhật đơn hàng" ? "active" : ""}`} onClick={() => handleSelectCategory("Cập nhật đơn hàng")}>
                <FaBell /> Cập nhật đơn hàng
              </Link>
              <Link href="/profile/khuyen-mai" className={`profile-submenu-item ${selectedCategory === "Khuyến mãi" ? "active" : ""}`} onClick={() => handleSelectCategory("Khuyến mãi")}>
                <FaTags /> Khuyến mãi
              </Link>
            </div>
          )}
          ...
          {expanded["Quản lý yêu cầu"] && (
            <div className="profile-submenu">
              <Link href="/profile/danh-sach-lich-hen" className={`profile-submenu-item ${selectedCategory === "Danh sách lịch hẹn" ? "active" : ""}`} onClick={() => handleSelectCategory("Danh sách lịch hẹn")}>
                <FaCalendarAlt /> Danh sách lịch hẹn
              </Link>
              <Link href="/profile/danh-sach-yeu-cau" className={`profile-submenu-item ${selectedCategory === "Danh sách yêu cầu" ? "active" : ""}`} onClick={() => handleSelectCategory("Danh sách yêu cầu")}>
                <FaClipboardList /> Danh sách yêu cầu
              </Link>
            </div>
          )}
          ...
          {expanded["Quản lý thông tin tài khoản"] && (
            <div className="profile-submenu">
              <Link href="/profile/thong-tin-tai-khoan" className={`profile-submenu-item ${selectedCategory === "Thông tin tài khoản" ? "active" : ""}`} onClick={() => handleSelectCategory("Thông tin tài khoản")}>
                <FaUser /> Thông tin tài khoản
              </Link>
              <Link href="/profile/thay-doi-mat-khau" className={`profile-submenu-item ${selectedCategory === "Thay đổi mật khẩu" ? "active" : ""}`} onClick={() => handleSelectCategory("Thay đổi mật khẩu")}>
